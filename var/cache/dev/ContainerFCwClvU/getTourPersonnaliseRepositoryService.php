 ...
 */
class getTourPersonnaliseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TourPersonnaliseRepository' shared autowired service.
     *
     * @return \App\Repository\TourPersonnaliseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TourPersonnaliseRepository.php';

        return $container->privates['App\\Repository\\TourPersonnaliseRepository'] = new \App\Repository\TourPersonnaliseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
